...
var daily_reward = 0, last_claim = 0, next_claim = 0, available_withdrawl = 0, last_withdraw = 0, next_withdraw = 0, total_withdrawn = 0;
...
export default {
    ...
    created() {
        this.statistics = {
            ...
            "aw": {"left": `<span>Available Withdrawal 50% Allowed <br> ${available_withdrawl}BUSD</span>`, "right": `<div class="button" style="padding: 1vw">WITHDRAW</div>`},
